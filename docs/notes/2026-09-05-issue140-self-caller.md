...
教訓は 1 つである．**副作用を量として論じる場面では，
先に効果を測る．** その選択肢が目的の量をどれだけ動かすかを見る．
順序を逆にすると，効果ゼロの案へ精緻な反論を組み立てることになる．

適用範囲は限る．後述の案 1 は「1 つのファイルが 2 つの役割を兼ねる」という
構造上の理由で棄却しており，量の問いに馴染まない．
定性的な理由による即時棄却まで足止めする教訓ではない．
...
作成時刻は 14:04 と 14:09（UTC）だった．
当該ファイルが PR ブランチへ入ったのは 13:42 である．
